...
var componentName = /*#__PURE__*/function (_Component) {
  ...
  function componentName(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "calcActiveStyle", function (index, type) {
  ...
  _createClass(componentName, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        className: classPrefix('TabItem-active-indicator') + (isInit ? '' : ' ' + classPrefix('TabItem-active-indicator-transition')),
        style: {
